...
public class AbstractComponentTest {
    ...
    public static final List<KMessage> MESSAGES = IntStream.range(0, 10).boxed()
    ...
    protected void assertThatSourceContainsAllMessages(Source source) throws Exception {
